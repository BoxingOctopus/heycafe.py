...
class ChatResource(BaseResource):
    ...
    def info(self, query: str, **params: str) -> dict:
        ...
        return self._client.get("get_chat_info", params={"query": query, **params}, use_api_key=True)
    ...
    def messages(self, query: str, **params: str) -> dict:
        ...
        return self._client.get("get_chat_messages", params={"query": query, **params}, use_api_key=True)
    ...
    def invite(self, query: str, **data: str) -> dict:
        ...
        return self._client.post("post_chat_invite", data={"query": query, **data}, use_api_key=True)
    ...
    def message_create(self, query: str, **data: str) -> dict:
        ...
        return self._client.post("post_chat_message_create", data={"query": query, **data}, use_api_key=True)

    def update_description(self, query: str, **data: str) -> dict:
        """Update chat description. Requires API key."""
        return self._client.post("post_chat_update_description", data={"query": query, **data}, use_api_key=True)

    def update_emoji(self, query: str, **data: str) -> dict:
        """Update chat emoji. Requires API key."""
        return self._client.post("post_chat_update_emoji", data={"query": query, **data}, use_api_key=True)

    def update_name(self, query: str, **data: str) -> dict:
        """Update chat name. Requires API key."""
        return self._client.post("post_chat_update_name", data={"query": query, **data}, use_api_key=True)
